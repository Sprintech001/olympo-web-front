<script>
    ...
    const createSessionsForSelectedDays = async () => {
        ...
        try {
            ...
            console.log('Sessões criadas com sucesso:', sessionIds);
            return sessionIds;  
        } catch (error) {
            console.error('Erro na criação das sessões:', error);
            throw error; 
        }
    };
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const sessionIds = await createSessionsForSelectedDays();  
            ...
            console.log('Todos os dias processados com sucesso');
        } catch (error) {
